...
// PN_ARTOFBALANCE_KERBEROS_PASSWORD.
...
// GetUserFriendPIDs is used by friend-scoped matchmaking searches. Art of
// Balance's server has no friends system, so it always returns an empty
// list -- a friend-filtered search just finds nobody.
