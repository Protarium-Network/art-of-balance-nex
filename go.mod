module github.com/Protarium-Network/art-of-balance-nex
...
// Ranking needs mode-aware queries (GetRankingsByMode) and a PID-scoped
// GetCommonData that upstream v2.4.0 does not expose (see NOTICE / RECON.md).
// Vendored from hyrule-warriors-nex's fork, datastore subpackage dropped
// (unused here - Art of Balance links no DataStore).
